...
namespace Nihility.X0.Solution.Controllers.api
{
    [Authorize]
    ...
    public class AccountServiceController : ApiControllerBase
    {
        ...
        public AccountServiceController(IErrorService errorService,ApplicationUserManager userManager, ISecureDataFormat<AuthenticationTicket> accessTokenFormat) : base(errorService)
        {
